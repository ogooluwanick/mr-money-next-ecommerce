                ...
                <form className='loginForm' onSubmit={handleSubmit(submitHandler)}>
                        {
                                ...
                                (
                                        <>
                                                ...
                                                <div class="input-wrapper">
                                                        {/* <label for="login-username" htmlFor="email">Email</label> */}
                                                ...
                                                <div class="input-wrapper">
                                                        ...
                                                        <div class="input-group">
                                                                ...
                                                                <input id="password"  type="password" aria-describedby="passwordHelpBlock" placeholder='Password' {
                                                                                ...register(      "password",
                                                                                                        {
                                                ...
                                                <div className="isSignupFunc_Container">
                                                        {!isSignup?"Already have an account? ":"Dont have an account?"} &nbsp; <span className='formLinks' onClick={()=>setIsSignup(prev=>!prev)}>{isSignup?"Sign up":"Sign in"}</span>
                                                </div>
                                        </>
                                )
                                :
                                (
                                        <>
                                                        ...
                                                        <div class="input-wrapper">
                                                        {/* <label for="login-username" htmlFor="fname">First Name</label> */}
                                                        <div class="input-group">
                                                                <span class="icon">
                                                                        <svg viewBox="0 0 24 24"><path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path> </svg>
                                                                </span>
                                                                <input id="login-username" type="text" placeholder='First Name' />
                                                        </div>
                                                </div>
                                                <div class="input-wrapper">
                                                        {/* <label for="login-password" htmlFor="email">Last Name</label> */}
                                                        <div class="input-group">
                                                                <span class="icon">
                                                                        <svg viewBox="0 0 24 24"><path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path> </svg>
                                                                </span>
                                                                <input id="login-password"  type="password" aria-describedby="passwordHelpBlock" placeholder='Last Name'/>
                                                        </div>
                                                </div>
                                                <div class="input-wrapper">
                                                        ...
                                                        <div class="input-group">
                                                                ...
                                                                <input id="login-password"  type="email" aria-describedby="passwordHelpBlock" placeholder='Email'/>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="input-wrapper">
                                                        ...
                                                        <div class="input-group"><span class="icon">
                                                                ...
                                                                <input id="login-password"  type="password" aria-describedby="passwordHelpBlock" placeholder='Password'/>
                                                        </div>
                                                </div>
                                                        ...
                                                        <div className='isSignupFunc_Container'>
                                                                {isSignup?"Dont have an account? ":"Already have an account? "} &nbsp; <span className='formLinks' onClick={()=>setIsSignup(prev=>!prev)}> {isSignup?" Sign up":" Sign in"}</span>
                                                        </div>
                                        </>
                                )
                        }
